...
def load_lats(lats, lat_strings):
    ...
    ax1.scatter(LAT[0], FREE_ENERGIES[0], c=(0, 0.5, 1), marker='.')
    ...
    ax1.set_ylim((-19.18437, -19.18395))
    
    ax2 = ax1.twinx()
    plt.ticklabel_format(useOffset=False)
    ax2.get_yaxis().get_major_formatter().set_scientific(False)
    ax2.scatter(LAT[25], FREE_ENERGIES[25], c=(1, 0.5, 0), marker='.')
    ax2.plot(LAT[25], fitted_energies[25], 'r')
    ax2.set_ylabel(r'Free energy at $T=500K$ $(Ry)$', color='r')
    ax2.tick_params('y', colors='r')
    ax2.set_ylim((-19.1961, -19.1955))
